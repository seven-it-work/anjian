...
public class ConstraintSet {
    ...
    static {
        ...
        sparseIntArray.append(C0028R.styleable.ConstraintSet_layout_constraintLeft_toLeftOf, 25);
        ...
        mapToConstant.append(C0028R.styleable.ConstraintSet_layout_constraintLeft_creator, 75);
        mapToConstant.append(C0028R.styleable.ConstraintSet_layout_constraintTop_creator, 75);
        mapToConstant.append(C0028R.styleable.ConstraintSet_layout_constraintRight_creator, 75);
        mapToConstant.append(C0028R.styleable.ConstraintSet_layout_constraintBottom_creator, 75);
        mapToConstant.append(C0028R.styleable.ConstraintSet_layout_constraintBaseline_creator, 75);
        ...
        mapToConstant.append(C0028R.styleable.ConstraintSet_layout_constraintWidth_percent, 69);
        mapToConstant.append(C0028R.styleable.ConstraintSet_layout_constraintHeight_percent, 70);
        mapToConstant.append(C0028R.styleable.ConstraintSet_chainUseRtl, 71);
        mapToConstant.append(C0028R.styleable.ConstraintSet_barrierDirection, 72);
        mapToConstant.append(C0028R.styleable.ConstraintSet_constraint_referenced_ids, 73);
        mapToConstant.append(C0028R.styleable.ConstraintSet_barrierAllowsGoneWidgets, 74);
    }
    ...
    private int[] convertReferenceString(View view, String str) {
        ...
        while (i2 < split.length) {
            ...
            try {
                i = C0028R.id.class.getField(trim).getInt(null);
    ...
    public void clone(ConstraintSet constraintSet) {
        ...
        for (Integer num : constraintSet.mConstraints.keySet()) {
            this.mConstraints.put(num, constraintSet.mConstraints.get(num).m13979clone());
        }
    }
