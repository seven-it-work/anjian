...
public class Analyzer {
    ...
    private static int getMaxDimensionTraversal(ConstraintWidget constraintWidget, int i, boolean z, int i2) {
        ...
        while (it.hasNext()) {
            i9 = Math.max(i9, getMaxDimensionTraversal(((ResolutionAnchor) it.next()).myAnchor.mOwner, i, z, i11));
        }
        int i12 = 0;
        for (Iterator<ResolutionNode> it2 = constraintWidget.mListAnchors[i5].getResolutionNode().dependents.iterator(); it2.hasNext(); it2 = it2) {
            i12 = Math.max(i12, getMaxDimensionTraversal(((ResolutionAnchor) it2.next()).myAnchor.mOwner, i, z, width2 + i11));
        }
        if (z2) {
            i9 -= height;
        ...
        if (i == 1) {
            ...
            while (it3.hasNext()) {
                ...
                if (i6 == i13) {
                    i14 = Math.max(i14, getMaxDimensionTraversal(resolutionAnchor.myAnchor.mOwner, i, z, height + i11));
                    it3 = it4;
                } else {
                    i14 = Math.max(i14, getMaxDimensionTraversal(resolutionAnchor.myAnchor.mOwner, i, z, (baselineDistance * i6) + i11));
                    it3 = it4;
                    i5 = i5;
                }
                i13 = 1;
            ...
            i7 = i5;
            int i15 = i14;
            i8 = (constraintWidget.mBaseline.getResolutionNode().dependents.size() <= 0 || z2) ? i15 : i6 == 1 ? i15 + height : i15 - baselineDistance;
        } else {
            i7 = i5;
            i8 = 0;
        }
