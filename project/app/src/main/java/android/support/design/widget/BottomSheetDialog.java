...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    private static int getThemeResId(Context context, int i) {
        ...
        return context.getTheme().resolveAttribute(C0035R.attr.bottomSheetDialogTheme, typedValue, true) ? typedValue.resourceId : C0035R.style.Theme_Design_Light_BottomSheetDialog;
    }

    private View wrapInBottomSheet(int i, View view, ViewGroup.LayoutParams layoutParams) {
        FrameLayout frameLayout = (FrameLayout) View.inflate(getContext(), C0035R.layout.design_bottom_sheet_dialog, null);
        CoordinatorLayout coordinatorLayout = (CoordinatorLayout) frameLayout.findViewById(C0035R.id.coordinator);
        if (i != 0 && view == null) {
            view = getLayoutInflater().inflate(i, (ViewGroup) coordinatorLayout, false);
        }
        FrameLayout frameLayout2 = (FrameLayout) coordinatorLayout.findViewById(C0035R.id.design_bottom_sheet);
        ...
        coordinatorLayout.findViewById(C0035R.id.touch_outside).setOnClickListener(new View.OnClickListener() { // from class: android.support.design.widget.BottomSheetDialog.1
