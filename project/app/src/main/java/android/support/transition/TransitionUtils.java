...
class TransitionUtils {
    ...
    public static View copyViewImage(ViewGroup viewGroup, View view, View view2) {
        ...
        imageView.measure(View.MeasureSpec.makeMeasureSpec(round3 - round, InterfaceC2667e.f10237e), View.MeasureSpec.makeMeasureSpec(round4 - round2, InterfaceC2667e.f10237e));
