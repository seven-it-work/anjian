...
class ImageViewUtilsApi14 implements ImageViewUtilsImpl {
    ...
    public void reserveEndAnimateTransform(final ImageView imageView, Animator animator) {
        animator.addListener(new AnimatorListenerAdapter() { // from class: android.support.transition.ImageViewUtilsApi14.1
            ...
            public void onAnimationEnd(Animator animator2) {
                ImageView.ScaleType scaleType = (ImageView.ScaleType) imageView.getTag(C0128R.id.save_scale_type);
                imageView.setScaleType(scaleType);
                imageView.setTag(C0128R.id.save_scale_type, null);
                if (scaleType == ImageView.ScaleType.MATRIX) {
                    imageView.setImageMatrix((Matrix) imageView.getTag(C0128R.id.save_image_matrix));
                    imageView.setTag(C0128R.id.save_image_matrix, null);
                }
    ...
    public void startAnimateTransform(ImageView imageView) {
        ...
        imageView.setTag(C0128R.id.save_scale_type, scaleType);
        if (scaleType == ImageView.ScaleType.MATRIX) {
            imageView.setTag(C0128R.id.save_image_matrix, imageView.getImageMatrix());
        } else {
