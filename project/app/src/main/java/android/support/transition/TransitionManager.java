...
public class TransitionManager {
    ...
    public static void beginDelayedTransition(@NonNull ViewGroup viewGroup, @Nullable Transition transition) {
        ...
        Transition mo13980clone = transition.mo13980clone();
        sceneChangeSetup(viewGroup, mo13980clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, mo13980clone);
    }
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition mo13980clone = transition.mo13980clone();
        mo13980clone.setSceneRoot(sceneRoot);
        Scene currentScene = Scene.getCurrentScene(sceneRoot);
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            mo13980clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, mo13980clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, mo13980clone);
    }
    ...
    /* renamed from: go */
    public static void m24go(@NonNull Scene scene) {
        changeScene(scene, sDefaultTransition);
    }

    /* renamed from: go */
    public static void m25go(@NonNull Scene scene, @Nullable Transition transition) {
