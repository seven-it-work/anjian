...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingChild, NestedScrollingParent {
    ...
    public void onMeasure(int i, int i2) {
        ...
        this.mTarget.measure(View.MeasureSpec.makeMeasureSpec((getMeasuredWidth() - getPaddingLeft()) - getPaddingRight(), InterfaceC2667e.f10237e), View.MeasureSpec.makeMeasureSpec((getMeasuredHeight() - getPaddingTop()) - getPaddingBottom(), InterfaceC2667e.f10237e));
        this.mCircleView.measure(View.MeasureSpec.makeMeasureSpec(this.mCircleDiameter, InterfaceC2667e.f10237e), View.MeasureSpec.makeMeasureSpec(this.mCircleDiameter, InterfaceC2667e.f10237e));
        this.mCircleViewIndex = -1;
