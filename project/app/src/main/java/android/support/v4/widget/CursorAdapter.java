...
public abstract class CursorAdapter extends BaseAdapter implements CursorFilter.CursorFilterClient, Filterable {
    ...
    void init(Context context, Cursor cursor, int i) {
        ...
        this.mRowIDColumn = z ? cursor.getColumnIndexOrThrow(TrayContract.Preferences.Columns.f10375ID) : -1;
        if ((i & 2) == 2) {
    ...
    public Cursor swapCursor(Cursor cursor) {
        ...
        this.mRowIDColumn = cursor.getColumnIndexOrThrow(TrayContract.Preferences.Columns.f10375ID);
