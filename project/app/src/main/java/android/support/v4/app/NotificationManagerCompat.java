...
public final class NotificationManagerCompat {
    ...
    public static class CancelTask implements Task {
        ...
        public void send(INotificationSideChannel iNotificationSideChannel) throws RemoteException {
            if (this.all) {
                ...
                iNotificationSideChannel.cancel(this.packageName, this.f29id, this.tag);
            }
        }

        public String toString() {
            return "CancelTask[packageName:" + this.packageName + ", id:" + this.f29id + ", tag:" + this.tag + ", all:" + this.all + "]";
        }
    }
    ...
    public static class NotifyTask implements Task {
        ...
        @Override // android.support.v4.app.NotificationManagerCompat.Task
        public void send(INotificationSideChannel iNotificationSideChannel) throws RemoteException {
            iNotificationSideChannel.notify(this.packageName, this.f30id, this.tag, this.notif);
        }

        public String toString() {
            return "NotifyTask[packageName:" + this.packageName + ", id:" + this.f30id + ", tag:" + this.tag + "]";
        }
    }
