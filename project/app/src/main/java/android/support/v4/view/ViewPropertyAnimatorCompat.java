...
public final class ViewPropertyAnimatorCompat {
    ...
    /* renamed from: x */
    public final ViewPropertyAnimatorCompat m28x(float f) {
        View view = this.mView.get();
        if (view != null) {
            view.animate().x(f);
        }
    ...
    /* renamed from: y */
    public final ViewPropertyAnimatorCompat m29y(float f) {
        View view = this.mView.get();
        if (view != null) {
            view.animate().y(f);
        }
    ...
    /* renamed from: z */
    public final ViewPropertyAnimatorCompat m30z(float f) {
        View view = this.mView.get();
        if (view != null && Build.VERSION.SDK_INT >= 21) {
            view.animate().z(f);
        }
