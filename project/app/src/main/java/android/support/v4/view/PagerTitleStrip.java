...
public class PagerTitleStrip extends ViewGroup {
    ...
    public void setNonPrimaryAlpha(@FloatRange(from = 0.0d, m22to = 1.0d) float f) {
    ...
    public void updateTextPositions(int i, float f, boolean z) {
        ...
        this.mPrevText.layout(min2, i3, measuredWidth + min2, this.mPrevText.getMeasuredHeight() + i3);
        int max32 = Math.max((width - paddingRight) - measuredWidth3, i10 + this.mScaledTextSpacing);
        this.mNextText.layout(max32, i5, max32 + measuredWidth3, this.mNextText.getMeasuredHeight() + i5);
        this.mLastKnownPositionOffset = f;
        this.mUpdatingPositions = false;
    }
}
