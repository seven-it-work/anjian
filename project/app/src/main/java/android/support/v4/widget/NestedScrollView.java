...
public class NestedScrollView extends FrameLayout implements NestedScrollingChild2, NestedScrollingParent, ScrollingView {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (this.mFillViewport && View.MeasureSpec.getMode(i2) != 0 && getChildCount() > 0) {
            ...
            if (childAt.getMeasuredHeight() < measuredHeight) {
                childAt.measure(getChildMeasureSpec(i, getPaddingLeft() + getPaddingRight(), ((FrameLayout.LayoutParams) childAt.getLayoutParams()).width), View.MeasureSpec.makeMeasureSpec((measuredHeight - getPaddingTop()) - getPaddingBottom(), InterfaceC2667e.f10237e));
            }
        }
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:13:0x0066, code lost:
        ...
        if (r23.mScroller.springBack(getScrollX(), getScrollY(), 0, 0, 0, getScrollRange()) != false) goto L16;
     */
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:38:0x007f A[ADDED_TO_REGION, RETURN] */
