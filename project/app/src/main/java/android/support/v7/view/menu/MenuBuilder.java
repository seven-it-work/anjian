...
public class MenuBuilder implements SupportMenu {
    ...
    private void setShortcutsVisibleInner(boolean z) {
        this.mShortcutsVisible = z && this.mResources.getConfiguration().keyboard != 1 && this.mResources.getBoolean(C0328R.bool.abc_config_showMenuShortcutsWhenKeyboardPresent);
    }
