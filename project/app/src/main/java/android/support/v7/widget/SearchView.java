...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attributeSet) {
            this(context, attributeSet, C0328R.attr.autoCompleteTextViewStyle);
        }
    ...
    private static class UpdatableTouchDelegate extends TouchDelegate {
        ...
        public boolean onTouchEvent(MotionEvent motionEvent) {
            ...
            if (!z2 || this.mActualBounds.contains(x, y)) {
                f = x - this.mActualBounds.left;
                i = y - this.mActualBounds.top;
            } else {
    ...
    public SearchView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0328R.attr.searchViewStyle);
    }
    ...
    public SearchView(Context context, AttributeSet attributeSet, int i) {
        ...
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0328R.styleable.SearchView, i, 0);
        LayoutInflater.from(context).inflate(obtainStyledAttributes.getResourceId(C0328R.styleable.SearchView_layout, C0328R.layout.abc_search_view), (ViewGroup) this, true);
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(C0328R.id.search_src_text);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0328R.id.search_edit_frame);
        this.mSearchPlate = findViewById(C0328R.id.search_plate);
        this.mSubmitArea = findViewById(C0328R.id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0328R.id.search_button);
        this.mGoButton = (ImageView) findViewById(C0328R.id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0328R.id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0328R.id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0328R.id.search_mag_icon);
        ViewCompat.setBackground(this.mSearchPlate, obtainStyledAttributes.getDrawable(C0328R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(this.mSubmitArea, obtainStyledAttributes.getDrawable(C0328R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(obtainStyledAttributes.getDrawable(C0328R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(obtainStyledAttributes.getDrawable(C0328R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(obtainStyledAttributes.getDrawable(C0328R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(obtainStyledAttributes.getDrawable(C0328R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(obtainStyledAttributes.getDrawable(C0328R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = obtainStyledAttributes.getDrawable(C0328R.styleable.SearchView_searchHintIcon);
        TooltipCompat.setTooltipText(this.mSearchButton, getResources().getString(C0328R.string.abc_searchview_description_search));
        this.mSuggestionRowLayout = obtainStyledAttributes.getResourceId(C0328R.styleable.SearchView_suggestionRowLayout, C0328R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = obtainStyledAttributes.getResourceId(C0328R.styleable.SearchView_commitIcon, 0);
        ...
        setIconifiedByDefault(obtainStyledAttributes.getBoolean(C0328R.styleable.SearchView_iconifiedByDefault, true));
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(C0328R.styleable.SearchView_android_maxWidth, -1);
        if (dimensionPixelSize != -1) {
            setMaxWidth(dimensionPixelSize);
        }
        this.mDefaultQueryHint = obtainStyledAttributes.getText(C0328R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = obtainStyledAttributes.getText(C0328R.styleable.SearchView_queryHint);
        int i2 = obtainStyledAttributes.getInt(C0328R.styleable.SearchView_android_imeOptions, -1);
        if (i2 != -1) {
            setImeOptions(i2);
        }
        int i3 = obtainStyledAttributes.getInt(C0328R.styleable.SearchView_android_inputType, -1);
        if (i3 != -1) {
            setInputType(i3);
        }
        setFocusable(obtainStyledAttributes.getBoolean(C0328R.styleable.SearchView_android_focusable, true));
    ...
    private Intent createVoiceAppSearchIntent(Intent intent, SearchableInfo searchableInfo) {
        ...
        PendingIntent activity = PendingIntent.getActivity(getContext(), 0, intent2, InterfaceC2667e.f10237e);
    ...
    private int getPreferredHeight() {
        return getContext().getResources().getDimensionPixelSize(C0328R.dimen.abc_search_view_preferred_height);
    }

    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(C0328R.dimen.abc_search_view_preferred_width);
    }
    ...
    void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int dimensionPixelSize = this.mIconifiedByDefault ? resources.getDimensionPixelSize(C0328R.dimen.abc_dropdownitem_icon_width) + resources.getDimensionPixelSize(C0328R.dimen.abc_dropdownitem_text_padding_left) : 0;
