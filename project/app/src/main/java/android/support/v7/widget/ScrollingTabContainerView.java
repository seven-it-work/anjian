...
public class ScrollingTabContainerView extends HorizontalScrollView implements AdapterView.OnItemSelectedListener {
    ...
    public class TabView extends LinearLayout {
        ...
        public TabView(Context context, ActionBar.Tab tab, boolean z) {
            super(context, null, C0328R.attr.actionBarTabStyle);
            this.BG_ATTRS = new int[]{R.attr.background};
            this.mTab = tab;
            TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, null, this.BG_ATTRS, C0328R.attr.actionBarTabStyle, 0);
        ...
        public void onMeasure(int i, int i2) {
            ...
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(ScrollingTabContainerView.this.mMaxTabWidth, InterfaceC2667e.f10237e), i2);
        }
        ...
        public void update() {
            ...
            if (z) {
                if (this.mTextView == null) {
                    AppCompatTextView appCompatTextView = new AppCompatTextView(getContext(), null, C0328R.attr.actionBarTabTextStyle);
    ...
    private Spinner createSpinner() {
        AppCompatSpinner appCompatSpinner = new AppCompatSpinner(getContext(), null, C0328R.attr.actionDropDownStyle);
    ...
    private LinearLayoutCompat createTabLayout() {
        LinearLayoutCompat linearLayoutCompat = new LinearLayoutCompat(getContext(), null, C0328R.attr.actionBarTabBarStyle);
    ...
    public void onMeasure(int i, int i2) {
        ...
        int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(this.mContentHeight, InterfaceC2667e.f10237e);
