...
class TooltipPopup {
    ...
    public TooltipPopup(Context context) {
        ...
        this.mContentView = LayoutInflater.from(this.mContext).inflate(C0328R.layout.abc_tooltip, (ViewGroup) null);
        this.mMessageView = (TextView) this.mContentView.findViewById(C0328R.id.message);
        ...
        this.mLayoutParams.windowAnimations = C0328R.style.Animation_AppCompat_Tooltip;
    ...
    private void computePosition(View view, int i, int i2, boolean z, WindowManager.LayoutParams layoutParams) {
        ...
        int dimensionPixelOffset = this.mContext.getResources().getDimensionPixelOffset(C0328R.dimen.tooltip_precise_anchor_threshold);
        if (view.getWidth() < dimensionPixelOffset) {
            i = view.getWidth() / 2;
        }
        if (view.getHeight() >= dimensionPixelOffset) {
            int dimensionPixelOffset2 = this.mContext.getResources().getDimensionPixelOffset(C0328R.dimen.tooltip_precise_anchor_extra_offset);
        ...
        int dimensionPixelOffset3 = this.mContext.getResources().getDimensionPixelOffset(z ? C0328R.dimen.tooltip_y_offset_touch : C0328R.dimen.tooltip_y_offset_non_touch);
        ...
        if (this.mTmpDisplayFrame.left < 0 && this.mTmpDisplayFrame.top < 0) {
            ...
            int identifier = resources.getIdentifier("status_bar_height", "dimen", C1225b.f4510b);
