...
class MessageThreadUtil<T> implements ThreadUtil<T> {
    ...
    /* loaded from: classes.dex */
    class C03351 implements ThreadUtil.MainThreadCallback<T> {
        ...
        private Runnable mMainThreadRunnable = new Runnable() { // from class: android.support.v7.util.MessageThreadUtil.1.1
            ...
            public void run() {
                while (true) {
                    SyncQueueItem next = C03351.this.mQueue.next();
                    if (next != null) {
                        switch (next.what) {
                            case 1:
                                C03351.this.val$callback.updateItemCount(next.arg1, next.arg2);
                                break;
                            case 2:
                                C03351.this.val$callback.addTile(next.arg1, (TileList.Tile) next.data);
                                break;
                            case 3:
                                C03351.this.val$callback.removeTile(next.arg1, next.arg2);
                                break;
                            default:
        ...
        C03351(ThreadUtil.MainThreadCallback mainThreadCallback) {
    ...
    /* loaded from: classes.dex */
    class C03362 implements ThreadUtil.BackgroundCallback<T> {
                ...
                while (true) {
                    ...
                    switch (next.what) {
                        case 1:
                            ...
                            C03362.this.val$callback.refresh(next.arg1);
                            break;
                        case 2:
                            C03362.this.mQueue.removeMessages(2);
                            C03362.this.mQueue.removeMessages(3);
                            C03362.this.val$callback.updateRange(next.arg1, next.arg2, next.arg3, next.arg4, next.arg5);
                            break;
                        case 3:
                            C03362.this.val$callback.loadTile(next.arg1, next.arg2);
                            break;
                        case 4:
                            C03362.this.val$callback.recycleTile((TileList.Tile) next.data);
                            break;
                        default:
                            Log.e("ThreadUtil", "Unsupported message, what=" + next.what);
                            break;
        ...
        C03362(ThreadUtil.BackgroundCallback backgroundCallback) {
    ...
    public ThreadUtil.BackgroundCallback<T> getBackgroundProxy(ThreadUtil.BackgroundCallback<T> backgroundCallback) {
        return new C03362(backgroundCallback);
    }

    @Override // android.support.v7.util.ThreadUtil
    public ThreadUtil.MainThreadCallback<T> getMainThreadProxy(ThreadUtil.MainThreadCallback<T> mainThreadCallback) {
        return new C03351(mainThreadCallback);
    }
}
