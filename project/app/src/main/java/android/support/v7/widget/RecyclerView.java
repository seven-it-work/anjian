...
public class RecyclerView extends ViewGroup implements NestedScrollingChild2, ScrollingView {
    ...
    public static abstract class LayoutManager {
        ...
        */
        ...
        public static Properties getProperties(Context context, AttributeSet attributeSet, int i, int i2) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0329R.styleable.RecyclerView, i, i2);
            properties.orientation = obtainStyledAttributes.getInt(C0329R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = obtainStyledAttributes.getInt(C0329R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = obtainStyledAttributes.getBoolean(C0329R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = obtainStyledAttributes.getBoolean(C0329R.styleable.RecyclerView_stackFromEnd, false);
        ...
        */
        ...
        void setExactMeasureSpecsFrom(RecyclerView recyclerView) {
            setMeasureSpecs(View.MeasureSpec.makeMeasureSpec(recyclerView.getWidth(), InterfaceC2667e.f10237e), View.MeasureSpec.makeMeasureSpec(recyclerView.getHeight(), InterfaceC2667e.f10237e));
        }
        ...
        void setRecyclerView(RecyclerView recyclerView) {
            ...
            this.mHeight = height;
            this.mWidthMode = InterfaceC2667e.f10237e;
            this.mHeightMode = InterfaceC2667e.f10237e;
        }
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes2 = context.obtainStyledAttributes(attributeSet, C0329R.styleable.RecyclerView, i, 0);
            String string = obtainStyledAttributes2.getString(C0329R.styleable.RecyclerView_layoutManager);
            if (obtainStyledAttributes2.getInt(C0329R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
                setDescendantFocusability(262144);
            }
            this.mEnableFastScroller = obtainStyledAttributes2.getBoolean(C0329R.styleable.RecyclerView_fastScrollEnabled, false);
            if (this.mEnableFastScroller) {
                initFastScroller((StateListDrawable) obtainStyledAttributes2.getDrawable(C0329R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), obtainStyledAttributes2.getDrawable(C0329R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) obtainStyledAttributes2.getDrawable(C0329R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), obtainStyledAttributes2.getDrawable(C0329R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
            }
    ...
    */
    ...
    String exceptionLabel() {
        return C1176s.a.f4108a + super.toString() + ", adapter:" + this.mAdapter + ", layout:" + this.mLayout + ", context:" + getContext();
    }
    ...
    */
    ...
    void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        ...
        new FastScroller(this, stateListDrawable, drawable, stateListDrawable2, drawable2, resources.getDimensionPixelSize(C0329R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0329R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0329R.dimen.fastscroll_margin));
    }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (this.mLayout.isAutoMeasureEnabled()) {
            ...
            if (this.mLayout.shouldMeasureTwice()) {
                this.mLayout.setMeasureSpecs(View.MeasureSpec.makeMeasureSpec(getMeasuredWidth(), InterfaceC2667e.f10237e), View.MeasureSpec.makeMeasureSpec(getMeasuredHeight(), InterfaceC2667e.f10237e));
                this.mState.mIsMeasuring = true;
                dispatchLayoutStep2();
                this.mLayout.setMeasuredDimensionFromChildren(i, i2);
                return;
