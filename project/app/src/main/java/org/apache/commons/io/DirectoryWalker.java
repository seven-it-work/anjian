...
public abstract class DirectoryWalker<T> {
    ...
    protected DirectoryWalker(IOFileFilter iOFileFilter, IOFileFilter iOFileFilter2, int i) {
        IOFileFilter m12430or;
        if (iOFileFilter == null && iOFileFilter2 == null) {
            m12430or = null;
        } else {
            m12430or = FileFilterUtils.m12430or(FileFilterUtils.makeDirectoryOnly(iOFileFilter == null ? TrueFileFilter.TRUE : iOFileFilter), FileFilterUtils.makeFileOnly(iOFileFilter2 == null ? TrueFileFilter.TRUE : iOFileFilter2));
        }
        this.filter = m12430or;
        this.depthLimit = i;
    }
