...
public class SharedPreferencesImport implements TrayMigration {
    ...
    public void onPostMigrate(TrayItem trayItem) {
        ...
        if (equals(trayItem.value(), getData().toString())) {
            TrayLog.m12288v("removing key '" + this.mSharedPrefsKey + "' from SharedPreferences '" + this.mSharedPrefsName + "'");
    ...
    public boolean shouldMigrate() {
        ...
        TrayLog.m12288v("key '" + this.mSharedPrefsKey + "' in SharedPreferences '" + this.mSharedPrefsName + "' not found. skipped import");
        return false;
    }
