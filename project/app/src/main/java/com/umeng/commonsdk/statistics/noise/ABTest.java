...
public class ABTest implements InterfaceC2564d {
    ...
    public String getGroupInfo() {
        return !this.isInTest ? C2427b.f8943J : String.valueOf(this.mGroup);
    }
    ...
    public void onExperimentChanged(String str, int i) {
        ...
        try {
            ...
            this.isInTest = false;
            MLog.m11271e("v:" + str, e);
        }
    }

    @Override // com.umeng.commonsdk.statistics.internal.InterfaceC2564d
    public void onImprintChanged(C2545g.a aVar) {
        onExperimentChanged(aVar.m11408a("client_test", null), Integer.valueOf(aVar.m11408a("test_report_interval", "0")).intValue());
    }
