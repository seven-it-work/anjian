...
public class StatTracer implements InterfaceC2562b {
    ...
    /* loaded from: classes.dex */
    private static class C2560a {

        /* renamed from: a */
        public static final StatTracer f9860a = new StatTracer();
    ...
    public static StatTracer getInstance(Context context) {
        if (mContext == null) {
            if (context != null) {
                ...
                MLog.m11269e("inside StatTracer. please check context. context must not be null!");
            }
        }
        return C2560a.f9860a;
    }
    ...
    @Override // com.umeng.commonsdk.statistics.internal.InterfaceC2562b
