...
public class LogThreadPoolManager {
    ...
    private final ThreadPoolExecutor mThreadPool = new ThreadPoolExecutor(1, 1, 5000, TimeUnit.MILLISECONDS, new ArrayBlockingQueue(SIZE_WORK_QUEUE), new ThreadFactory() { // from class: com.alibaba.sdk.android.oss.common.LogThreadPoolManager.3
