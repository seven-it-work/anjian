...
public abstract class Message implements Part {
    ...
    public static class RecipientType implements Serializable {
        ...
        /* renamed from: TO */
        public static final RecipientType f10034TO = new RecipientType("To");

        /* renamed from: CC */
        public static final RecipientType f10033CC = new RecipientType("Cc");
    ...
    public Address[] getAllRecipients() throws MessagingException {
        int i;
        Address[] recipients = getRecipients(RecipientType.f10034TO);
        Address[] recipients2 = getRecipients(RecipientType.f10033CC);
