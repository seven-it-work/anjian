    ...
    private void queueEvent(MailEvent mailEvent, Vector vector) {
        synchronized (this.qLock) {
            if (this.f10032q == null) {
                this.f10032q = new EventQueue();
            }
        }
        this.f10032q.enqueue(mailEvent, (Vector) vector.clone());
    }
    ...
    private void terminateQueue() {
        synchronized (this.qLock) {
            if (this.f10032q != null) {
                ...
                vector.setSize(1);
                this.f10032q.enqueue(new TerminatorEvent(), vector);
                this.f10032q = null;
            }
        }
    }
