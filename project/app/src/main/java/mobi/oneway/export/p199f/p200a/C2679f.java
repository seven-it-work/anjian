...
/* renamed from: mobi.oneway.export.f.a.f */
/* loaded from: classes2.dex */
public class C2679f extends AbstractC2674a implements OWInterstitialAdListener {
    public C2679f(C2673a c2673a) {
        super(c2673a);
    }
    ...
    public void onAdFinish(String str, OnewayAdCloseType onewayAdCloseType, String str2) {
        m12096a(onewayAdCloseType == OnewayAdCloseType.SKIPPED ? EventType.skip : EventType.end);
        if (this.f10301e != null) {
