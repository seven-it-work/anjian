...
/* renamed from: mobi.oneway.export.b.b.a */
/* loaded from: classes2.dex */
public abstract class AbstractC2650a extends AbstractC2651b<AdMonitor> {
    public AbstractC2650a(AdType adType, List<String> list, long j) {
        super(adType, list, j);
    }
    ...
    protected void mo11942a() {
        if (this.f10202a != 0) {
            ((AdMonitor) this.f10202a).onAdReady();
        }
    }
    ...
    protected void mo11943a(String str) {
        if (this.f10202a != 0) {
            ((AdMonitor) this.f10202a).onSdkError(OnewaySdkError.LOAD_ERROR, str);
        }
    }
    ...
    public void mo11945a(String str, OnewayAdCloseType onewayAdCloseType) {
        if (this.f10202a != 0) {
            ((AdMonitor) this.f10202a).onAdClose(str, onewayAdCloseType);
        }
    }
    ...
    public void mo11946a(String str, OnewayAdCloseType onewayAdCloseType, String str2) {
        if (this.f10202a != 0) {
            ((AdMonitor) this.f10202a).onAdFinish(str, onewayAdCloseType, str2);
        }
    }
    ...
    public void mo11947a(String str, OnewaySdkError onewaySdkError, String str2) {
        ...
        ((AdMonitor) this.f10202a).onSdkError(onewaySdkError, str2);
    }
    ...
    public void mo11949c(String str) {
        m11960a(false);
        if (this.f10202a != 0) {
            ((AdMonitor) this.f10202a).onAdShow(str);
        }
    }
    ...
    public void mo11950d(String str) {
        if (this.f10202a != 0) {
            ((AdMonitor) this.f10202a).onAdClick(str);
        }
    }
